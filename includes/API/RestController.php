...
class RestController {
	...
	public function register_routes(): void {
		...
		register_rest_route(
			self::NAMESPACE,
			'/wenpai-git/(?P<repo>[a-zA-Z0-9_-]+/[a-zA-Z0-9_.-]+)/releases',
			[
				'methods'             => \WP_REST_Server::READABLE,
