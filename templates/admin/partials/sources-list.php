...
$render_test_status = function( string $source_id, bool $enabled ) use ( $health_status ) {
    ...
    if ( $status && is_array( $status ) ) {
        ...
        $classes = [ 'healthy' => 'wpbridge-badge-success', 'degraded' => 'wpbridge-badge-warning', 'failed' => 'wpbridge-badge-danger' ];
        $labels  = [ 'healthy' => __( '正常', 'wpbridge' ), 'degraded' => __( '降级', 'wpbridge' ), 'failed' => __( '失败', 'wpbridge' ) ];
